...
1. Integration points
    - [readme](https://github.com/Microsoft/AppInsights-aspnet5/blob/master/Readme.md)
...
[Issue](https://github.com/Microsoft/AppInsights-aspnet5/issues/24)
...
[Issue](https://github.com/Microsoft/AppInsights-aspnet5/issues/25)
- Split application insights into two packages - one with MVC reference, one without.
[Issue](https://github.com/Microsoft/AppInsights-aspnet5/issues/26)
...
**Demo feedback**
- Ability to filter out (not send) long running requests [Issue](https://github.com/Microsoft/AppInsights-aspnet5/issues/27)
